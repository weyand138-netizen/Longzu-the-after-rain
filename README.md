...
- 原创背景音乐、环境声、交互音效与场景美术；
- 存档、读取、回退、文字速度、自发声及多项无障碍设置。
...
也可从 Ren'Py SDK 根目录执行，将 `<项目目录>` 替换为本仓库所在位置：

```powershell
.\lib\py3-windows-x86_64\python.exe renpy.py <项目目录> run
```

## 内容与授权

- 制作人署名：Andwey
- 游戏文本、原创 UI、原创图像与音频：权利保留，未授予商业复用许可。
