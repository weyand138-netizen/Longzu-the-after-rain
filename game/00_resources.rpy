...
image char erii neutral = Transform("assets/characters/erii/char_erii_stand_neutral.png", xalign=0.74, yalign=1.0, zoom=0.36)
...
image char erii paper_observation = Transform("assets/characters/erii/char_erii_look_down_wish_paper.png", xalign=0.18, yalign=1.0, xzoom=-0.50, yzoom=0.50)
...
image char lu mingfei paper_observation = Transform("assets/characters/lu_mingfei/char_lu_mingfei_look_down_wish_paper.png", xalign=0.18, yalign=1.0, zoom=0.58)
image prop wish_paper = Transform("assets/props/prop_wish_paper.png", xalign=0.50, yalign=0.43, zoom=0.20)
