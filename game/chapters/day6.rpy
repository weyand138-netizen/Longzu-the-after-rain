...
label chapter_day6_no_safe_house:
    ...
    narrator "门锁响过以后，屋里还是原来的屋里：水杯停在窗沿，外套搭在椅背，铁盒盖没有扣上。正因为没有人破门而入，走廊尽头那盏灯才更让我不安。它本该熄着，现在却透过门缝把一条长亮的线切到地板上。我没有看见谁按了开关，只能承认安全屋已经不能再让我假装没有风险。"
    narrator "我把桌上的东西逐件数了一遍。票的边角没有湿，联系人卡还在夹层，路线图的折痕从售票窗一路延到这里，愿望纸的边缘已经干了。每一件都来自前几天一个已经发生的动作，没有哪一件是临时从口袋里变出来救场的答案。数清它们不是为了让自己放心，是为了别在最急的时候把没有的东西说成有。"
    narrator "绘梨衣把东西放在桌上时，先让票和卡分开，随后把路线图摊平。她没有把任何一件递给我。我看见她把选择留在桌面上，便没有越过桌沿去把它们塞进自己的包。门外也许有人，时间也许不够，可这些都不能替我取得她手里的物件。"
    narrator "我问：\"你要先带哪一个？\""
    narrator "她没有回答句子，只把最靠近自己的东西压住，又向门口看了一眼。她没有指向一条完整路线，也没有把票交给我。我只能从这个动作确认，她不愿意让手边的东西被风或我仓促带走；剩下出口怎么走，仍要由我把能看见的事实说出来。"
    ...
    narrator "旧身份凭据放在铁盒旁，纸角被我捏得卷起。它上面有我的照片、旧名字和一串能让人顺着查回去的数字。烧掉它不是干净地抹去过去，更不是把麻烦变成英雄式的动作；我看得见的只是，烧掉以后会少一张能证明我是谁的纸，也会多一段必须由我承担的追查。"
    ...
    narrator "她看着铁盒，随后又看向路线图。她没有把手覆到我手上，也没有替我点火。我没有要求她见证，也不把沉默写成共同承担。能做的只有把笔从她那一栏移开，把要联系谁、怎么拖住追踪、失去证件以后如何面对，逐条写到我自己的名字下面。"
    ...
    narrator "我不再把“我们怎么办”说得像一个可以由我一个人回答的问题。要是她握住卡，我能确认卡在她手里；要是她把票留在夹层，我能确认票没有被退回；要是纸上只剩空白，我也能确认空白没有凭空变成许可。每一种事实都会把我带向不同的动作，也都会留下不同的代价。"
    ...
    narrator "她没有立刻回答。她先把手指放到卡、票或地图上，停到足够让我看清，再把东西收进自己的夹层，或把它留在桌上。我等她完成动作，才把门外的时间、出口和我已经写下的承担告诉她。路线由此得到的不是保证，只是一种不再冒充她同意的执行方式。"
    ...
    narrator "离开安全屋前，我回头看了一次桌面。铁盒盖已经扣好，水杯停在窗边，路线图上有些折痕被灯照得很白。这里曾经被我当作可以暂时躲进去的地方，现在却只剩一间门锁响过、灯光异常的房间。它没有替我们保住任何答案，也不能再要求绘梨衣把自己的物件交出来换一点虚假的安全。"
    narrator "她先检查夹层，再把手放回自己最先保留的那件东西上。可能是票，可能是卡，也可能只是一张还没能变成路线的纸。我没有替她翻开，也没有要求看清。她带走什么，是她刚刚用手保住的事实；我带走什么，是我写在自己名字下面的代价和后果。"
    narrator "我把门把轻轻按下，先听走廊里有没有脚步。没有声音并不等于没有人，只有我此刻没有听见。我把这点说出来：\"外面暂时安静。\"我没有说安全，也没有说已经没人。她听见后看向门口，没有把手里的东西交给我。"
    narrator "走廊的灯照在地板上，像一条不太可靠的线。我们如果走，要经过那条线；如果停，也会留在门锁已经被注意到的地方。我没有把这两种现实排成谁更高尚、谁更胆小的答案。选择会有后果，后果也不会因为我替它起一个好听的名字而少一点。"
    ...
    narrator "我没有把这些风险再念一遍让她害怕。她已经看过票面、卡片说明或地图上的空白。重复它们只会把我自己的焦虑压给她。我只告诉她我会处理哪一部分：旧身份的余波、可能追到的线索和我写下的联络。她要保留的部分仍留在她自己手里。"
    narrator "走到楼梯口时，风从破开的窗缝钻进来。她停下来把纸角压平，我站在旁边等。没有人追来，也没有奇迹替我们解决门锁和档案。只有她把纸收好、我没有抢过去的这一小段时间，真实地留在楼梯的冷风里。"
    narrator "我想起最初在站台说过共同承担。现在我明白，承担不是把每一样东西攥到同一只手里，更不是在她没有回答时替她说“我们”。我能承担的是我造成的风险、我选择的代价、我应该去做的事；她能保留的是她已经收好的票、卡、名字和路线。"
    narrator "我没有再说“我来处理”然后把她推到身后。我只是走到门边，让她看清出口在哪儿，走廊往哪儿拐，灯在哪里闪。她如果看向别的方向，我会先停下来问。安全屋失效以后，我们仍然只有能看见的事实，正因为这样，更不能靠我的想象把她的回答补齐。"
