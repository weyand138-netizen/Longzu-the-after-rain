...
label chapter_day5_family_lie:
    ...
    narrator "我把原页和摘要分开放。两页摘要简短明白，原页却满是日期、签名和对不上的记录。前者省事，后者留下更多连我也答不出的疑问。无论交哪份，都有代价。"
    ...
    narrator "她没拿走档案，也没推回来，只压平那页，把手留在上面。我曾想略过的部分，如今就在她眼前，还能重新核对。"
    ...
    narrator "她合好夹层，没有递给我。我可以写清门外的时间、能去的地点和联络方式；至于要不要照着走，还得等她拿出自己的票或卡。"
    narrator "我翻到空白面，写下三件事：确认出口、处理身份、把原页留在她拿得到的地方。接着本想写“她会……”，笔尖却停住了。那一行不该由我填。"
    ...
    narrator "我曾说是形势所迫：雨大、时间少、追踪者太近、命令难违。里面有事实，也有我逃避的借口。承认这些不会让危险消失，但我做过的事，也不能都算到形势头上。"
    ...
    narrator "她看着纸上的字，手指在空白边停了一会儿，没有替我开脱。我写下后续步骤，是让她以后能核对，不是要她现在就原谅。"
    ...
    narrator "风停了，档案、票、卡和路线图仍分开放着，旁边是我填过或留空的责任栏。它们来自不同日子，我没把站台、街机、教室和售票窗的事叠成一个结论。"
    ...
    narrator "灯照着原页折痕。我看见路线图的一角、收据的白边、游戏币压过的圆印，还有照片里未解释的阴影。交出过什么、扣住过什么，都留着痕迹。"
    ...
    narrator "包带擦过门框，收据在里面轻响。我没有伸手检查。她从第一天起，便自己收好纸张，后来又安放了昵称、硬币、票或卡。谈责任，也不能把这些重新收回我手里。"
    ...
    narrator "走廊尽头的窗映着湿夜。她看过什么，我承认什么，还要做什么，终于分得清一些，不能再用一句“为了她”带过。"
    ...
    narrator "我记住责任纸上的日期。以后每一步都要对照：旧身份的线索有没有收束，来源是否仍能让她看见，危险有没有又推给她。把纸折好，不代表这些已经做完。"
