...
label chapter_day4_seaside_train:
    ...
    narrator "售票窗下的金属槽很窄，零钱一旦滚到里面，就得伸手很深才能拿出来。她把硬币排成一列时，先把最小的一枚推到最靠里，再把能买票的几张纸币压在路线图角上。我看见她是在分开东西，不知道她心里给它们排了什么顺序；我便不替她把哪一枚说成最重要。"
    ...
    narrator "我把证件从钱包里抽出又放回去。照片上的人是我，名字也是我；它们是否要被交到窗口，后果会先落在我身上。可票一旦被打出来，能不能拿、要不要上车，又会落到她手里。分清这些并不能让我轻松，只让我不至于把自己的承担说成替她作出的选择。"
    ...
    narrator "我把票价在心里算了一遍。两张靠窗票要报出姓名，也会在窗口留下准确的车次；一张现金票能少留一点记录，却把另一张座位完全留白。没有哪一项是我可以假装没看见的代价。我把这些能确认的部分一条条说出来，停在事实处，不替她说害怕还是想走。"
    narrator "她听着时，手指一直压在路线图边缘。售票窗里传来翻票本的声音，车次的最后购票时间也在牌子上闪。她没有因为倒计时而把纸片塞回袖口，也没有把我的话当成命令。我只能等她做出看得见的动作，而不是用时间替我解释她的沉默。"
    ...
    menu:
        ...
        "买一张现金票，让她决定是否独自上车":
            ...
            narrator "她把票背面对着我，读了一遍开车时间。她没有说会不会上车，也没有把票塞回窗口。我看见她让这张票留在能够决定的位置，便不再问她是不是一个人害怕、不上车是不是更好。那些问题听起来像关心，实际上会逼她替我的担心作答。"
    ...
    if (
        ...
        menu:
            ...
            "不登记联系人，让她把游戏币和纸片收回去":
                ...
                narrator "纸片被她折到看不见昵称的一面，游戏币压在外层。她把两样东西放进自己的口袋，先按住口袋口，再把手收回。没有卡片从窗口滑回来，也没有号码被登记；我看见的是一条没有被建立的联系，不把它说成她以后一定会后悔的空缺。"
    ...
    narrator "列车开动后，站台的灯向后退。她等车门边的人散开，才走到窗前。玻璃外的海线仍只是灰蓝色的一段缝，偶尔被隧道吞掉。我看见她看向那里，不知道她把那段颜色当成什么，便没有用“海”替她把愿望纸上的某一项提前完成。"
    narrator "我问：\"要坐这里吗？\""
    ...
    narrator "靠窗玻璃上慢慢凝起雾，她用指尖擦出一小块。外面的水面终于显出一点纹路，又被下一盏信号灯切开。我没有问她是不是想看海，只让那块玻璃留给她自己。列车把我们带向下一站，票和路线图仍然各自保管在原来的地方。"
    ...
    narrator "她把路线图摊在腿上，折痕压着一小片窗光。我看不见夹层里到底放着哪件东西，也不要求她翻开给我看。票面、联系人卡和没有登记的纸片会在不同选择里留下不同的空白；我能确定的只是它们都曾被她亲手收进自己能碰到的位置。"
    narrator "我记得在售票窗前，自己的手曾在证件和零钱之间犹豫。现在钱包贴着掌心，边角仍有一点湿。我没有用“我已经付了”催她使用任何一张票。付钱、递出名字和走进一扇车门都是我的动作；她要不要让下一步继续，得看她后来真正拿出什么。"
    narrator "列车穿进隧道，玻璃变成镜子。黑色的窗里只剩车厢灯和我们隔着过道的影子。我看见她抬手碰了一下玻璃，又收回去。镜中的影子靠得很近，现实里的距离却仍在。我不把反光剪掉的距离叫成她没有说过的话。"
    narrator "隧道尽头亮起来时，她先眯了一下眼，随后继续看窗外。海线又出现了，不过只是灰蓝色的一段平面。我没有替她确认那就是愿望纸上写过的海，也没有说列车朝着海开就等于愿望已经实现。看见颜色和抵达某处之间，还隔着她自己的选择。"
    ...
    narrator "车厢广播报出安全提示，声音平静得像在念天气。绘梨衣听完后把口袋按平。我没有问她是不是记住了紧急出口，也没有替她背出每一条提示。她已经看过出口、票和窗口；我能做的是让她看见我也留意到它们，而不是把知识变成我控制她的理由。"
    ...
    narrator "车厢里一个孩子把糖纸揉成团，糖纸滚到过道中央。绘梨衣低头看了一眼，没有去捡。我弯腰把糖纸推到自己的鞋边，等乘务员过来。这个动作和她的票无关，我也不拿它换她的注意。能帮上的小事不该成为我要求她回应的筹码。"
    narrator "经过河桥时，桥下的水面短暂亮起来。她把额头靠近玻璃，却没有贴上去。风景从窗外向后退，我看不见她眼里留下了什么。她若要告诉我，我会听；她没有告诉我，我就不把河、海和任何远处的颜色排成她心里的顺序。"
    narrator "我想起她在售票窗前分别碰过车次、座位和联系人纸片。那几个动作不是让我替她从中选一个答案，而是让我明白它们可以被分开保留。列车开出去以后，这个差别仍在：我可以为实名付出代价，不能借代价把别的选择一并收走。"
